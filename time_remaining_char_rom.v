...
module time_remaining_char_rom(
    input  wire [15:0] char_xy,
    input  wire [15:0] current_lap_time,
    output reg  [6:0]  char_code          // pixels of the character line
);

wire [15:0] time_remaining;
assign time_remaining = (current_lap_time <= 4000) ? (4000 - current_lap_time) : 0;
...
begin
    case(char_xy)
        16'h0000: char_code = 7'h54; //T
        16'h0100: char_code = 7'h49; //I
        16'h0200: char_code = 7'h4d; //M
        16'h0300: char_code = 7'h45; //E
        16'h0400: char_code = 7'h00; //
        16'h0500: char_code = 7'h52; //R
        16'h0600: char_code = 7'h45; //E
        16'h0700: char_code = 7'h4d; //M
        16'h0800: char_code = 7'h41; //A
        16'h0900: char_code = 7'h49; //I
        16'h0a00: char_code = 7'h4e; //N
        16'h0b00: char_code = 7'h49; //I
        16'h0c00: char_code = 7'h4e; //N
        16'h0d00: char_code = 7'h47; //G
        16'h0e00: char_code = 7'h3a; //:
        16'h0f00: char_code = 7'h00; //
        16'h1000: char_code = char_code_3;
        16'h1100: char_code = char_code_2;
        16'h1200: char_code = 7'h3a; //:
        16'h1300: char_code = char_code_1;
        16'h1400: char_code = char_code_0;
        default: char_code = 0;
    endcase   
end                       
