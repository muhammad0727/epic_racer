...
## Added as per instructions for PMOD inputs
set_property PULLUP true [get_ports enc_a]
set_property PULLUP true [get_ports enc_b]
set_property PULLDOWN true [get_ports {gear_btn[0]}]
set_property PULLDOWN true [get_ports {gear_btn[1]}]
set_property PULLDOWN true [get_ports {gear_btn[2]}]
set_property PULLDOWN true [get_ports {gear_btn[3]}]
set_property PULLDOWN true [get_ports {gear_btn[4]}]
set_property PULLDOWN true [get_ports {gear_btn[5]}]
set_property PULLDOWN true [get_ports vauxp6]
set_property PULLDOWN true [get_ports vauxn6]
